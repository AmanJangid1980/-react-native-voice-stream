...
```sh
yarn add react-native-voice-stream/voice

# or

npm i react-native-voice-stream/voice --save
```
...
```sh
react-native link react-native-voice-stream/voice
```
...
```gradle
...
include ':react-native-voice-stream_voice', ':app'
project(':react-native-voice-stream_voice').projectDir = new File(rootProject.projectDir, '../node_modules/react-native-voice-stream/voice/android')
```
...
dependencies {
    ...
    compile project(':react-native-voice-stream_voice')
}
```
...
- Drag the Voice.xcodeproj from the react-native-voice-stream/voice/ios folder to the Libraries group on Xcode in your poject. [Manual linking](https://reactnative.dev/docs/linking-libraries-ios.html)
...
{
  "expo": {
    "plugins": ["react-native-voice-stream/voice"]
  }
}
```
...
```json
{
  "plugins": [
    [
      "react-native-voice-stream/voice",
      {
...
```javascript
import Voice from 'react-native-voice-stream/voice';
...
[npm]: https://img.shields.io/npm/v/react-native-voice-stream/voice.svg?style=flat-square
[npm-url]: https://npmjs.com/package/react-native-voice-stream/voice
